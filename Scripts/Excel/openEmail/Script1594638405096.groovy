...
not_run: WebUI.waitForElementPresent(findTestObject('email/divLoading'), 0)

not_run: WebUI.waitForElementNotPresent(findTestObject('email/divLoading'), 0)
...
not_run: WebUI.click(findTestObject('email/button_URLLink'))
...
not_run: WebUI.waitForElementPresent(findTestObject('Master/divLoadingFPPOnline'), 0)

not_run: WebUI.waitForElementNotPresent(findTestObject('Master/divLoadingFPPOnline'), 0)
