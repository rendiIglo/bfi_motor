...
WebUI.setText(findTestObject('FPP Online Personal/popUpZipCode/txtKelurahan'), 'Medan')
...
WebUI.setText(findTestObject('FPP Online Personal/popUpZipCode/txtKelurahan'), 'Papua')
