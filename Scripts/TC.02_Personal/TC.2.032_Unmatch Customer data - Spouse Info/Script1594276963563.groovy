...
WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/ddlMaritalStatusItem-Married'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/chkUnmatchSpouseName'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/chkUnmatchSpouseMobileNo'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/chkUnmatchSpouseDOB'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/chkUnmatchSpouseIDNo'))

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/txtSpouseName'), 'Bambang Yudhoyono')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/txtSpouseMobilePhone'), '081987654321')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/txtSpouseDOB'), '06/02/1960')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Customer/txtSpouseIDNo'), '1234561234567890')
