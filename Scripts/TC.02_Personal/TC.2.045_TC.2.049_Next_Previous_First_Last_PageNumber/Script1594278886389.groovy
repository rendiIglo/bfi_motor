...
WebUI.scrollToElement(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnChoose'), 0)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnPageNext'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnPagePrevious'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnPageLast'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnPageFirst'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtPageNo'))

WebUI.sendKeys(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtPageNo'), Keys.chord(
        Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtPageNo'), '3')
