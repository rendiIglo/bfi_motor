...
WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtKelurahan'), 'sido mulyo')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtKecamatan'), 'medan tuntungan')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtCity'), 'medan')
