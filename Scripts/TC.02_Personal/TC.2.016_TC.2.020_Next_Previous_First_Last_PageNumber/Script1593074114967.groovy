...
WebUI.click(findTestObject('AdminVer Personal/btnNext'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/btnPrevious'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/btnLastPage'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/btnFirstPage'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/txtPagingNo'))

WebUI.sendKeys(findTestObject('AdminVer Personal/txtPagingNo'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('AdminVer Personal/txtPagingNo'), '3')

WebUI.sendKeys(findTestObject('AdminVer Personal/txtPagingNo'), Keys.chord(Keys.TAB))
