...
WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/LeadDetail/SpanFoundFirst'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/LeadDetail/btnUnMatch'))

WebUI.delay(3)

WebUI.scrollToElement(findTestObject('AdminVer Personal/Detail/Document Checklist/data/LeadDetail/SpanScrollColletaralInfo'), 
    0)
