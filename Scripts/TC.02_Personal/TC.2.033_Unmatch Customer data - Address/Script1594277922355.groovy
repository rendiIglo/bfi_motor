...
WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtZipCode'), '20137')
...
WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnChoose'))

WebUI.delay(1)

WebUI.takeScreenshot(FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/btnNext'))
