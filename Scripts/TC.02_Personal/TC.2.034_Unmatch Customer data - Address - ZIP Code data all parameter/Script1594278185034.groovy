...
WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/divAddress'))

WebUI.delay(1)

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/chkUnmatchAddress'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/chkUnmatchRTRW'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/chkUnmatchZipCode'))

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/txtAddress'), 'Jalan Akasia raya No.445')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/txtRT'), '009')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/txtRW'), '009')

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/ddlProvince'))

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/ddlProvinceItem_JawaBarat'))

WebUI.comment('Popup ZipCode')

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/btnPopUpZipCode'))
...
WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtZipCode'), '17216')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtKelurahan'), 'Pahlawan Setia')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtKecamatan'), 'Tarumajaya')

WebUI.setText(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/txtCity'), 'Bekasi')

WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/btnSearch'))
...
WebUI.click(findTestObject('AdminVer Personal/Detail/Document Checklist/data/Address/popUpZipCode/SpanFoundFirst'))
