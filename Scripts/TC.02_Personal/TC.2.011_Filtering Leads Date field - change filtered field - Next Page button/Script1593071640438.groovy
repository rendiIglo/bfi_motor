...
WebUI.setText(findTestObject('AdminVer Personal/txtLeadsDateFrom'), '01/01/2020')

WebUI.setText(findTestObject('AdminVer Personal/txtLeadsDateTo'), '20/06/2020')

WebUI.click(findTestObject('AdminVer Personal/btnSearch'))

WebUI.waitForElementPresent(findTestObject('AdminVer Personal/divLoadSearch'), 0)

WebUI.waitForElementNotPresent(findTestObject('AdminVer Personal/divLoadSearch'), 0)

WebUI.delay(1)

WebUI.setText(findTestObject('AdminVer Personal/txtLeadsDateTo'), '20/12/2020')

WebUI.setText(findTestObject('AdminVer Personal/txtLeadsDateFrom'), '01/07/2020')
