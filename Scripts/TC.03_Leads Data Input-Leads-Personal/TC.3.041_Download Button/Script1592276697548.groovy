...
not_run: WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-Personal/Leads Info/Document/PopupUpload/a_FileDeleteButton'))
...
WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-Personal/Leads Info/Document/a_PreviewButton'))

not_run: WebUI.switchToFrame(findTestObject('Master/iframe_idIframe'), 0)

not_run: WebUI.scrollToPosition(0, 3000)

WebUI.delay(1)

WebUI.click(findTestObject('TC.03_Leads Data Input-Leads-Personal/Leads Info/Document/a_DownloadButton'))
