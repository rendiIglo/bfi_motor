...
WebUI.setText(findTestObject('TC.02_Leads Data Search-Leads-Personal/txtLeadsName'), 'Winarsih')
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/ddl_SurveyStatus'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_ddlSurveyStatus_LossData'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('TC.02_Leads Data Search-Leads-Personal/txtLeadsDateFrom'), '23/03/2020')
