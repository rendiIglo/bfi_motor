...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/a_NextPage_SearchList'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/a_PreviousPage_SearchList'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/a_LastPage_SearchList'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/a_FirstPage_SearchList'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/input_pagingtxtbox_SearchList'))

WebUI.sendKeys(findTestObject('TC.02_Leads Data Search-Leads-Personal/input_pagingtxtbox_SearchList'), Keys.chord(Keys.CONTROL, 
        'a'))

WebUI.sendKeys(findTestObject('TC.02_Leads Data Search-Leads-Personal/input_pagingtxtbox_SearchList'), Keys.chord('2'))

WebUI.sendKeys(findTestObject('TC.02_Leads Data Search-Leads-Personal/input_pagingtxtbox_SearchList'), Keys.chord(Keys.TAB))
