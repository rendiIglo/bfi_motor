...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_LeadsDate'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_UserInputLeads'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_LeadsID'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_LeadsName'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_CustomerStatus'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_CustomerType'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_DataType'))
...
WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_sort_LeadsStatus'))
