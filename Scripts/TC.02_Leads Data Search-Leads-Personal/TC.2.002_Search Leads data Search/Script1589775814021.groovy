...
WebUI.setText(findTestObject('TC.02_Leads Data Search-Leads-Personal/txtLeadsID'), '202005')

WebUI.setText(findTestObject('TC.02_Leads Data Search-Leads-Personal/txtLeadsName'), 'Komariah')

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/ddl_CustomerStatus'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_ddlCustomerStatus_New'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/ddl_CustomerType'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_ddlCustomerType_Personal'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/ddl_LeadsStatus'), FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_LeadsStatus_UnSubmitedLeadsDI'), FailureHandling.STOP_ON_FAILURE)
...
not_run: WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_ddlSurveyStatus_BatalSurvey'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('TC.02_Leads Data Search-Leads-Personal/txtLeadsDateFrom'), '01/05/2020')

WebUI.setText(findTestObject('TC.02_Leads Data Search-Leads-Personal/txtLeadsDateTo'), '30/05/2020')

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/ddl_DataType'))

WebUI.click(findTestObject('TC.02_Leads Data Search-Leads-Personal/span_ddlDataType_Leads'))
