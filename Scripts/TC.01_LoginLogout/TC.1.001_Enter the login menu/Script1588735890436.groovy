...
not_run: WebUI.setText(findTestObject('Login/input_Username_UserName'), 'sylvia')

not_run: WebUI.setEncryptedText(findTestObject('Login/input_Username_Password'), 'XxvbDbwTCRrM3Plt9LzERg==')

not_run: WebUI.click(findTestObject('Login/a_Login'))
