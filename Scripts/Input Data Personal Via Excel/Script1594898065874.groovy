...
WebUI.waitForElementNotPresent(findTestObject('Master/divLoading'), 40)

WebUI.delay(1)

WebUI.waitForElementClickable(findTestObject('TC.03_Leads Data Input-Leads-Personal/Leads Info/Address/a_ZIPCode'), 45)
...
WebUI.waitForElementNotPresent(findTestObject('Master/divLoadingPopUp'), 40)
