...
WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_AttachIcon'))

CustomKeywords.'rendi.uploadNativePopUpWindow.uploadFile'(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_AttachIcon'), 
    'E:\\my Documents\\ekreasi\\internal project\\Katalon\\ndf-motor-personal\\LeadsDataUpload.xlsx')

WebUI.delay(1)

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_UploadButton'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_Ok'))
