...
WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_LeadsDataUpload'))
...
WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_NextPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_PreviousPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_LastPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_FirstPage'))

WebUI.delay(1)

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/txtPaging'))

WebUI.sendKeys(findTestObject('TC.04_Leads Data Upload-Leads-Personal/txtPaging'), Keys.chord(Keys.CONTROL, 'a'))

WebUI.sendKeys(findTestObject('TC.04_Leads Data Upload-Leads-Personal/txtPaging'), Keys.chord('2'))

WebUI.sendKeys(findTestObject('TC.04_Leads Data Upload-Leads-Personal/txtPaging'), Keys.chord(Keys.TAB))
