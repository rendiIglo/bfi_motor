...
WebUI.setText(findTestObject('TC.04_Leads Data Upload-Leads-Personal/txtDateFrom'), '11/06/2020')

WebUI.setText(findTestObject('TC.04_Leads Data Upload-Leads-Personal/txtDateTo'), '11/05/2020')

WebUI.click(findTestObject('TC.04_Leads Data Upload-Leads-Personal/a_SearchDate'))
